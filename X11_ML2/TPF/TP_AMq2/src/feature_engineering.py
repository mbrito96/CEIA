...
class FeatureEngineeringPipeline():
    ...
    def data_transformation(self, data: pd.DataFrame) -> pd.DataFrame:
        ...
        productos = list(data[data['Item_Weight'].isnull()]
                         ['Item_Identifier'].unique())
        for producto in productos:
            moda = (data[data['Item_Identifier'] == producto]
        ...
        data.loc[data['Item_Type'] == 'Health and Hygiene',
                 'Item_Fat_Content'] = 'NA'
        ...
        # FEATURES ENGINEERING: asignación de nueva categorías para
        # 'Item_Fat_Content'
        data.loc[data['Item_Type'] == 'Non perishable',
                 'Item_Fat_Content'] = 'NA'

        # FEATURES ENGINEERING: Codificando los niveles de precios de los
        # productos
